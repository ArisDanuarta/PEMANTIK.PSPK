-- 1. Tambah kolom is_sandbox di tabel communities
ALTER TABLE public.communities
ADD COLUMN IF NOT EXISTS is_sandbox boolean NOT NULL DEFAULT false;

-- 2. Fungsi RPC untuk menyimpan entitas sekolah, kelas, dan siswa
--    CATATAN: auth.users dibuat dari Next.js Server Action (via auth.admin.createUser),
--    kemudian user_id yang sudah jadi dikirim ke fungsi ini melalui parameter.
