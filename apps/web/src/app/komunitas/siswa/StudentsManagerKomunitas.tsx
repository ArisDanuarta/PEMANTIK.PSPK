...
interface StudentsManagerKomunitasProps {
...
export default function StudentsManagerKomunitas({ initialStudents, schools, sesVariables = [], classes = [] }: StudentsManagerKomunitasProps) {
  ...
  const handleDownloadTemplate = () => {
    ...
    XLSX.writeFile(wb, "Template_Siswa_Komunitas.xlsx");
  };
