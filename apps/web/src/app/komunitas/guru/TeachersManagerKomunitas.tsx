...
interface TeachersManagerKomunitasProps {
  initialTeachers: Teacher[];
  schools: SchoolOption[];
  classes: ClassOption[];
}

export default function TeachersManagerKomunitas({ initialTeachers, schools, classes }: TeachersManagerKomunitasProps) {
  ...
  const handleDownloadTemplate = () => {
    ...
    XLSX.writeFile(wb, "Template_Guru_Komunitas.xlsx");
  };
  ...
  return (
    <div className="card" style={{ marginTop: "1rem" }}>
      ...
      {isManualModalOpen && mounted && createPortal(
        <div
          style={{ position: "fixed", inset: 0, backgroundColor: "rgba(0,0,0,0.5)", zIndex: 9999, padding: "2rem 1rem", overflowY: "auto", display: "flex", alignItems: "flex-start", justifyContent: "center" }}
      ...
      {isBulkModalOpen && (
        <BulkUploadModal
          title="Import Data Guru Binaan"
          description="Download template, isi data, lalu upload kembali. Guru yang ditambahkan akan divalidasi ke dalam sekolah binaan di komunitas Anda."
          templateFileName="Template_Guru_Komunitas"
          templateHeaders={["nama_guru", "email", "nip", "jenis_kelamin", "tanggal_lahir", "kelurahan", "kecamatan", "kabupaten", "provinsi", "nama_sekolah", "kelas"]}
