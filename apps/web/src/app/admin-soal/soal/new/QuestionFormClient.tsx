            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.5rem" }}>
              {imgOptions.map((opt, i) => (
                <div key={i} style={{ border: `2px solid ${i === imgCorrectIndex ? accent : "#e0e0e0"}`, borderRadius: "8px", overflow: "hidden", background: i === imgCorrectIndex ? accentBg : "#f8f9fa", position: "relative" }}>
                  {opt.url ? <img src={opt.url} alt={opt.label} style={{ width: "100%", height: "60px", objectFit: "contain", backgroundColor: "#f0f0f0", display: "block" }} /> : <div style={{ height: "60px", background: "#e9ecef", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "0.65rem", color: "black" }}>Gambar {i + 1}</div>}
          ...
          return (
            <>
              <div style={{ background: "#f0f0f0", borderRadius: "8px", padding: "0.5rem", marginBottom: "0.5rem", display: "flex", alignItems: "center", gap: "0.5rem" }}>
                ...
                <span style={{ fontSize: "0.7rem", color: "black" }}>{isAudio ? "Dengarkan audio, lalu pilih jawaban" : "Tonton video, lalu pilih jawaban"}</span>
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                {avOptions.map((opt, i) => (
      ...
      <div style={{
        ...
        <div className="card" style={{ padding: "2rem", marginBottom: "2rem" }}>
          ...
          <div style={{ marginBottom: "1.5rem", display: "flex", flexDirection: "column", gap: "0.5rem" }}>
            <label className="form-label" style={{ fontWeight: 600 }}
            >Instruksi Atas <span style={{ color: "black", fontWeight: 400, fontSize: "0.75rem" }}>- muncul SEBELUM media (contoh: "Dengarkan suara berikut")</span></label>
          ...
          <div style={{ marginBottom: "1.5rem", display: "flex", flexDirection: "column", gap: "0.5rem" }}>
            <label className="form-label" style={{ fontWeight: 600 }}
            >Teks Pertanyaan <span style={{ color: "black", fontWeight: 400, fontSize: "0.75rem" }}>- muncul SETELAH media (contoh: "Pilihlah suara yang kamu dengar")</span></label>
