            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.5rem" }}>
              {imgOptions.map((opt, i) => (
                <div key={i} style={{ border: `2px solid ${i === imgCorrectIndex ? accent : "#e0e0e0"}`, borderRadius: "8px", overflow: "hidden", background: i === imgCorrectIndex ? accentBg : "#f8f9fa", position: "relative" }}>
                  {opt.url ? <img src={opt.url} alt={opt.label} style={{ width: "100%", height: "60px", objectFit: "cover", display: "block" }} /> : <div style={{ height: "60px", background: "#e9ecef", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "0.65rem", color: "black" }}>Gambar {i + 1}</div>}
